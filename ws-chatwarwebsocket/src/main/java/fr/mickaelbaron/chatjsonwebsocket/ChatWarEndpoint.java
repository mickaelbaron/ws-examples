 ...
 */
@ServerEndpoint(value = "/chat/{chatroom}/{username}", decoders = ChatMessageDecoder.class, encoders = ChatMessageEncoder.class)
public class ChatWarEndpoint {
	...
	public void onMessage(Session session, ChatMessage message) {
		...
		this.broadcastObjectMessage(message, allUsers.get(session.getId()), null, allChatRooms.get(session.getId()));
	}

	@OnError
	public void onError(Throwable error) {
		System.out.println("ChatWarEndpoint.onError()");
